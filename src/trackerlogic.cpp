...
DynamicJsonDocument rack_json(1024);
int instance_idx [2] = { -1 };
int min_U = 2;
...
void updateSupposedReadings(int start_u){
    ...
    Serial.println(sizeof(rack_json["data"]));
    String temp_string2 = rack_json["data"][0];
    String temp_string3 = rack_json["data"][1];
    Serial.println("data[0]:");
    Serial.println(temp_string2);
    Serial.println("data[1]:");
    Serial.println(temp_string3);
